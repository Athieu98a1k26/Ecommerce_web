...
using Ecommerce.Models.TokenAuth;
...
{
    public abstract class EcommerceWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EcommerceWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EcommerceWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EcommerceDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EcommerceDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EcommerceDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EcommerceDbContext, Task<T>> func)
        {
            T result;
